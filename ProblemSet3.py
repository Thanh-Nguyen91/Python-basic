...
def problem3_3(month, day, year):
    ...
    # replace this pass (a do-nothing) statement with your code
    monthlet = ("January","February","March","April","May","June","July","August","September","October","November","December")
    newday = monthlet[month-1]+" "+str(day)+", "+str(year)
    print(newday)
#%%
"""
Problem 3_4:
...
def problem3_4(mon, day, year):
    ...
    newday = str(monthdic[mon])+"/"+str(day)+"/"+str(year)
    print(newday)
